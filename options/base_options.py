...
class BaseOptions():
    ...
    def initialize(self):
        self._parser.add_argument('--data_dir', type=str, default='./YCB_Affordance/', help='path to dataset')
        self._parser.add_argument('--mano_dir', type=str, default='./manopth/', help='path to dataset')
